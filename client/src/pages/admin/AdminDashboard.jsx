...
import { 
  Shield, BookOpen, Users, CheckCircle, XCircle, 
  Clock, Eye, TrendingUp, AlertCircle, Loader2 
} from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="flex items-center space-x-3">
        ...
        <div>
          ...
          <p className="text-gray-600">Manage content and moderate community submissions</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card>
          <CardContent className="p-6 text-center">
            ...
            <div className="text-2xl font-bold text-primary">{allBlogs.length}</div>
        ...
        <Card>
          <CardContent className="p-6 text-center">
            ...
            <div className="text-2xl font-bold text-secondary">{allCampaigns.length}</div>
        ...
        <Card>
          <CardContent className="p-6 text-center">
            ...
            <div className="text-2xl font-bold text-accent">
              {Math.round(((approvedBlogs.length + approvedCampaigns.length) / (allBlogs.length + allCampaigns.length)) * 100) || 0}%
            </div>
        ...
        <Card className="bg-yellow-50 border-yellow-200">
          <CardContent className="p-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="font-semibold text-yellow-800">Items Awaiting Review</h3>
                <p className="text-yellow-700">
                  You have {pendingBlogs.length} blog{pendingBlogs.length !== 1 ? 's' : ''} and {pendingCampaigns.length} campaign{pendingCampaigns.length !== 1 ? 's' : ''} pending approval.
                </p>
              </div>
            </div>
          </CardContent>
