...
import { Upload, Camera, Loader2, CheckCircle, Award, Recycle } from 'lucide-react';
...
const WasteClassifier = () => {
  ...
  const classifyMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      queryClient.invalidateQueries({ queryKey: ['/api/waste-classifications'] });
    },
    onError: (error) => {
      toast({
                ...
                {sampleImages.map((sample) => (
                  <Button
                    ...
                    onClick={() => {
                      ...
                      toast({
                        title: "Sample Image",
                        description: "Sample image functionality would be implemented here",
                      });
                    }}
                  >
                    {sample.name}
            ...
            {!classificationResult ? (
              ...
              <div className="space-y-6">
                ...
                <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                  ...
                  {/* Instructions */}
                  <div className="space-y-2">
                    <h5 className="font-semibold text-gray-900">Recycling Instructions:</h5>
                    <ul className="text-sm text-gray-600 space-y-1">
                      {classificationResult.instructions?.map((instruction, index) => (
